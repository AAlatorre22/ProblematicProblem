...
namespace ProblematicProblem
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            bool seeList = (contResponse == "sure") ? true : false; // same as: bool seeList = (contResponse);

            if (seeList) // same as: if (seeList = true)
            {
               ...
               // bool addToList = bool.Parse(Console.ReadLine());
                ...
                bool addToList = (contResponse == "yes") ? true : false;
                ...
                while (addToList)
                {
                    ...
                    //addMoreToList = bool.Parse(Console.ReadLine());
